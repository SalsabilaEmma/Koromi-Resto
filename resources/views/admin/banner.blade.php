                                                    ...
                                                    <td>
                                                        <div class="zoom">
                                                            <img id="file" class="profile-user-img img-responsive"
                                                                ...
                                                                src="{{ url('img/banner/' . $banner->file) }}" alt="Banner">
                                                        </div>
                                                    </td>
                ...
                <div class="modal-body">
                    <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" required class="form-control @error('judul') is-invalid @enderror"
                                    placeholder="Judul Banner" name="judul">
                                @error('judul')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" required class="form-control @error('keterangan') is-invalid @enderror"
                                    placeholder="Keterangan Banner" name="keterangan">
                                @error('keterangan')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            <label>File</label>
                            <div class="input-group">
                                <input type="file" required name="file" accept="img/*" id="file-input" onchange="imageExtensionValidate(this)"
